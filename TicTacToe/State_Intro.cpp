...
void State_Intro::OnCreate() {
	...
	evMgr->AddCallback(StateType::Intro, "Key_Escape",
		&State_Intro::Exit, this);
}
...
void State_Intro::OnDestroy() {
	...
	evMgr->RemoveCallback(StateType::Intro, "Key_Escape");
}
...
void State_Intro::Exit(EventDetails* l_details) {
